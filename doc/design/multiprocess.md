# Multiprocess BitcoinII Design Document
...
- **ipc::Exception class**: A class within BitcoinII Core's protocol-agnostic IPC code that is thrown by client class methods when there is an IPC error.
