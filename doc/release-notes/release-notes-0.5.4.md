BitcoinII version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoinII/files/BitcoinII/bitcoinII-0.5.4/
...
http://gitorious.org/bitcoinII/bitcoinIId-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BitcoinII-Qt notifications under Growl 1.3.
Increase required age of BitcoinII-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoinII properly when installing BitcoinII-Qt over it. (Windows)
