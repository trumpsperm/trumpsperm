...
fungibility of all bitcoinIIs. Spenders will enjoy lower fees and the
...
The addition of taproot-related features to BitcoinII Core's wallet is
...
### Documentation
- #21384 add signet to bitcoinII.conf documentation (jonatack)
