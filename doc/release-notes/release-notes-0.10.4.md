BitcoinII Core version 0.10.4 is now available from:

  <https://bitcoin.org/bin/bitcoinII-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoinII-tx into its own package
- #6953 `dfe0d4d` Include bitcoinII-tx binary on Debian/Ubuntu
