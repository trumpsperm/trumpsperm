Download URL: https://sourceforge.net/projects/bitcoinII/files/BitcoinII/bitcoinII-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BC2 fee schedule (users still pay 0.01 BC2 per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoinII00 - #bitcoinII99
