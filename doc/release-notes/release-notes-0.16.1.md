BitcoinII Core version 0.16.1 is now available from:

  <https://bitcoincore.org/bin/bitcoinII-core-0.16.1/>
...
- #12843 `df38b13` Test starting bitcoinIId with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure bitcoinIId processes are cleaned up when tests end (sdaftuar)
