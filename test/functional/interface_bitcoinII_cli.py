...
# The block reward of coinbaseoutput.nValue (50) BC2/block matures after
# COINBASE_MATURITY (100) blocks. Therefore, after mining 101 blocks we expect
# node 0 to have a balance of (BLOCKS - COINBASE_MATURITY) * 50 BC2/block.
...
WALLET_NOT_SPECIFIED = (
    ...
    "option before the command (run \"bitcoinII-cli -h\" for help or \"bitcoinII-cli listwallets\" to see "
...
class TestBitcoinIICli(BitcoinIITestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `bitcoinII-cli getblockchaininfo`")
        ...
        # Prevent bitcoinII-cli from using existing rpcport in conf
        ...
        self.log.info("Test -getinfo and bitcoinII-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and bitcoinII-cli getwalletinfo return expected wallet info")
            ...
            assert_equal(Decimal(cli_get_info['Transaction fee rate (-paytxfee) (BC2/kvB)']), wallet_info['paytxfee'])
            assert_equal(Decimal(cli_get_info['Min tx relay fee rate (BC2/kvB)']), network_info['relayfee'])
            ...
            # Mine a block to confirm; adds a block reward (50 BC2) to the default wallet.
            ...
            # Test bitcoinII-cli -generate with -rpcwallet in multiwallet mode.
...
if __name__ == '__main__':
    TestBitcoinIICli(__file__).main()
