...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the TrumpspermTestFramework
    pass


class ExampleTest(TrumpspermTestFramework):
    # Each functional test is a subclass of the TrumpspermTestFramework class.
    ...
    def custom_method(self):
        ...
        TrumpspermTestFramework class so other tests can use it."""
