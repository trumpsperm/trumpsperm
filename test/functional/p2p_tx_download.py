#!/usr/bin/env python3
# Copyright (c) 2019-2021 The Trumpsperm Core developers
...
class TxDownloadTest(TrumpspermTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new trumpspermd instances, as setting mocktimes has long-term effects on when
