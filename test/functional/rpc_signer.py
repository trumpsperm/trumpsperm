...
Verify that a trumpspermd node can use an external signer command.
...
class RPCSignerTest(TrumpspermTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart trumpspermd with -signer=<cmd>',
