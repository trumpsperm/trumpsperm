...
class TestShell:
    """Wrapper Class for TrumpspermTestFramework.

    The TestShell class extends the TrumpspermTestFramework
    ...
    class __TestShell(TrumpspermTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by TrumpspermTestFramework child class.
            self.num_nodes = 1
    ...
    def __new__(cls):
        ...
        if not TestShell.instance:
            # TrumpspermTestFramework instances are supposed to be constructed with the path
