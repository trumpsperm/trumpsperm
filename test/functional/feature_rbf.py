...
class ReplaceByFeeTest(TrumpspermTestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 TPS/kvB <= old feerate 0.00300000 TPS/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 TPS - so this attempt is rejected.
