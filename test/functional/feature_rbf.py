...
class ReplaceByFeeTest(BitcoinIITestFramework):
    ...
    def test_simple_doublespend(self):
        ...
        reject_details = f"{reject_reason}, rejecting replacement {tx.hash}; new feerate 0.00300000 BC2/kvB <= old feerate 0.00300000 BC2/kvB"
    ...
    def test_doublespend_chain(self):
        ...
        # child fees - 4 BC2 - so this attempt is rejected.
