...
"""Verify that starting bitcoinII with -h works as expected."""

from test_framework.test_framework import BitcoinIITestFramework
from test_framework.util import assert_equal

class HelpTest(BitcoinIITestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinII with -h for help text")
        ...
        self.log.info("Start bitcoinII with -version for version information")
        ...
        self.log.info("Start bitcoinIId with -fakearg to make sure it does not start")
