...
By default, trumpspermd will dump mempool on shutdown and
...
class MempoolPersistTest(TrumpspermTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent trumpspermd from writing mempool.dat to disk. Verify that `savemempool` fails")
