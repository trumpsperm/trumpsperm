...
class P2PFeelerReceiver(P2PInterface):
    def on_version(self, message):
        # The trumpspermd node closes feeler connections as soon as a version
...
class P2PAddConnections(TrumpspermTestFramework):
    ...
    def run_test(self):
        ...
        # trumpspermd behaves properly when a version is sent unexpectedly (but
        # tolerably) early.
        #
        # This checks that trumpspermd sends its own version prior to processing
