...
class SegWitTest(TrumpspermTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older trumpspermd's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let trumpspermd fill it in.
