 ...
 *  A CTxDestination is the internal data type encoded in a trumpsperm address
 */
...
/**
 * Generate a Trumpsperm scriptPubKey for the given CTxDestination. Returns a P2PKH
