...
#error Client version information missing: version is not defined by trumpsperm-build-config.h or in any other way
#endif
...
/**
 * trumpspermd-res.rc includes this file, but it cannot cope with real c++ code.
