...
#ifndef BITCOINII_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BITCOINII_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BITCOINII_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
