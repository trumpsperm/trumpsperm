...
static void SetupTrumpspermUtilArgs(ArgsManager &argsman)
{
...
static int AppInitUtil(ArgsManager& args, int argc, char* argv[])
{
    ...
    if (HelpRequested(args) || args.GetBoolArg("-version", false)) {
        ...
        std::string strUsage = CLIENT_NAME " trumpsperm-util utility version " + FormatFullVersion() + "\n";
        ...
        if (args.GetBoolArg("-version", false)) {
            ...
            strUsage += "\n"
                ...
                "\n"
                "Usage:  trumpsperm-util [options] [command]\n"
                "or:     trumpsperm-util [options] grind <hex-block-header>\n";
            strUsage += "\n" + args.GetHelpMessage();
        }
