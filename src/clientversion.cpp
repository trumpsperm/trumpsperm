 ...
 * for both trumpspermd and trumpsperm-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string UA_NAME("Satoshi");


#include <trumpsperm-build-info.h>
// The <trumpsperm-build-info.h>, which is generated by the build environment (cmake/script/GenerateBuildInfo.cmake),
...
/**
 * Format the subversion field according to BIP 14 spec (https://github.com/trumpsperm/bips/blob/master/bip-0014.mediawiki)
 */
...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure Trumpsperm Core copyright is not removed by accident
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/trumpsperm/trumpsperm>";

    // Печатаем копирайты в требуемом порядке и с индивидуальными годами
