...
const std::string CURRENCY_UNIT = "TPS"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    TPS_KVB,      //!< Use TPS/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::TPS_KVB) const;
