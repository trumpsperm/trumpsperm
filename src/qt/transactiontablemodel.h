...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, TrumpspermUnits::SeparatorStyle separators=TrumpspermUnits::SeparatorStyle::STANDARD) const;
