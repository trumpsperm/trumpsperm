...
/** Trumpsperm unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TrumpspermUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TrumpspermUnits(QObject *parent);
...
typedef TrumpspermUnits::Unit TrumpspermUnit;
