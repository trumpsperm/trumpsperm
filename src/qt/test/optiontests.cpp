...
{
    // Test regression https://github.com/trumpsperm/trumpsperm/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/trumpsperm-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/trumpsperm-core/gui/pull/568.
    // With fListen=false in ~/.config/Trumpsperm/Trumpsperm-Qt.conf and all else left as default,
    // trumpsperm-qt should set both -listen and -listenonion to false and start successfully.
