...
/** Main Trumpsperm application object */
class TrumpspermApplication: public QApplication
{
    Q_OBJECT
public:
    explicit TrumpspermApplication();
    ~TrumpspermApplication();
    ...
    /// Get window identifier of QMainWindow (TrumpspermGUI)
...
Q_SIGNALS:
    ...
    void windowShown(TrumpspermGUI* window);
