...
complete --command trumpsperm-qt --no-files

# Extract options
function __fish_trumpspermqt_get_options
...
complete \
    --command trumpsperm-qt \
    --arguments "(__fish_trumpspermqt_get_options)"
# Enable file completions only if the commandline now contains a `*.=` style option
complete -c trumpsperm-qt \
...
complete \
    --command trumpsperm-qt \
    --arguments "(__fish_trumpspermqt_get_options --nofiles)"
