...
# Extract options
function __fish_trumpsperm_tx_get_options
...
# Extract commands
function __fish_trumpsperm_tx_get_commands
...
# Add options
complete \
    --command trumpsperm-tx \
    --condition "not __fish_trumpsperm_seen_cmd (__fish_trumpsperm_tx_get_commands --commandsonly)" \
    --arguments "(__fish_trumpsperm_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command trumpsperm-tx \
    --arguments "(__fish_trumpsperm_tx_get_commands)" \
    --no-files
