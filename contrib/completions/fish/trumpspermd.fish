...
complete --command trumpspermd --no-files

# Extract options
function __fish_trumpspermd_get_options
...
complete \
    --command trumpspermd \
    --arguments "(__fish_trumpspermd_get_options --nofiles)"
