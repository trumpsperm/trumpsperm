...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINII_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINII_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the trumpsperm network\n')
    ...
    g.write('#endif // BITCOINII_CHAINPARAMSSEEDS_H\n')
