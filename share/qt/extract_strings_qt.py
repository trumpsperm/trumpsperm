#!/usr/bin/env python3
# Copyright (c) 2012-2021 The Trumpsperm Core developers
...
OUT_CPP="qt/trumpspermstrings.cpp"
EMPTY=['""']
...
#endif
""")
f.write('static const char UNUSED *trumpsperm_strings[] = {\n')
f.write('QT_TRANSLATE_NOOP("trumpsperm-core", "%s"),\n' % (os.getenv('COPYRIGHT_HOLDERS'),))
